...
export default function Dashboard() {
  ...
  const getTotalTasks = async () => {
    try {
      const response = await axios.get(TASKS_URLs.TotalTasks, AuthorizedToken);
      ...
      <div className={`${Styles.dashboardContainer} container-fluid my-4`}>
        <div className="row justify-content-between align-items-center gy-4">
          <div className="col-md-6 text-center text-md-start">
            <div className={`${Styles.bgCard} card-tasks py-4 rounded-4 px-4`}>
          ...
          <div className="col-md-6 text-center text-md-start">
            <div className={`${Styles.bgCard} card-Users py-4 rounded-4 px-4`}>
              <div className={`${Styles.titelCard} ps-3 `}>
                <h5>Users</h5>
                <p className="text-muted">
                  Lorem ipsum dolor sit amet,consecteture
